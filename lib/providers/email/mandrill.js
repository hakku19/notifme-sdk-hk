  ...
  return (0, _createClass2["default"])(EmailMandrillProvider, [{
    ...
    value: function () {
      var _send = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(request) {
        var _ref, id, userId, from, replyTo, returnPath, subject, html, text, headers, to, cc, bcc, attachments, response, responseBody, message;
              ...
              return (0, _request["default"])('https://mandrillapp.com/api/1.0/messages/send.json', {
                ...
                body: (0, _stringify["default"])({
                  ...
                  message: _objectSpread(_objectSpread({
                    ...
                    text: text,
                    html: html,
                    headers: _objectSpread(_objectSpread(_objectSpread({}, replyTo ? {
                      'Reply-To': replyTo
                    } : null), returnPath ? {
