  ...
  return (0, _createClass2["default"])(EmailSendGridProvider, [{
    ...
    value: function () {
      var _send = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(request) {
        var _ref, id, userId, from, replyTo, returnPath, subject, html, text, headers, to, cc, bcc, attachments, generatedId, response, responseBody, _responseBody$errors, firstError, message;
          ...
          while (1) switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              return (0, _request["default"])('https://api.sendgrid.com/v3/mail/send', {
                ...
                body: (0, _stringify["default"])(_objectSpread(_objectSpread(_objectSpread({
